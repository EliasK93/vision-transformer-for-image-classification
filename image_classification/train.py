...
if __name__ == '__main__':
    train_model(model_type="google/vit-base-patch16-224-in21k", epochs=1, batch_size=64, test_ratio=0.1,
                data_dir="./data_augmented/train/", output_dir="./", output_name="ViT-base-224")
